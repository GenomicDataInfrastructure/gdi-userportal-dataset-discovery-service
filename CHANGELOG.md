...
### Added
- feat: Enhanced CkanDatasetsMapper to map CkanValueLabel correctly, ensuring null handling for value and label by @Kacem Bechka in db331db


### Changed
- chore(deps): update registry.access.redhat.com/ubi9-minimal docker tag to v1784092978 by @Renovate Bot in 7744506
- chore(deps): update graalvm/setup-graalvm action to v1.6.3 by @Renovate Bot in 65d8b45
- doc: update CHANGELOG.md for v1.5.2 by @LNDS-Sysadmins in ac69f0c
...
### Added
- feat: enhance BeaconGVariantsRequestMapper to support position-only range queries and map variant details by @Kacem Bechka in b4117c1
...
### Added
- feat: update OpenAPI schema to allow nullable fields for description and ID by @Kacem Bechka in 88dd3a3


### Changed
- doc: update CHANGELOG.md for v1.3.47 by @LNDS-Sysadmins in 4782bc3
...
### Added
- feat: add dataset count functionality to DatasetsRepository and update SearchDatasetsQuery by @nolliia in 187eb43


### Changed
- doc: update CHANGELOG.md for v1.3.35 by @LNDS-Sysadmins in cf49262
